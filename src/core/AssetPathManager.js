...
class AssetPathManager {
    constructor() {
        ...
        this.images = {
            ...
            babao_sprite: `${this.basePath}characters/summon/babao_sprite.png`,
            ...
            stone_blast_projectile: `${this.basePath}effect/stone_blast_projectile.png`,
            stone_explosion_effect: `${this.basePath}effect/stone_explosion_effect.png`,
            rock_projectile: `${this.basePath}effect/rock_projectile.png`,
            ...
            zayn_cutscene: `${this.basePath}characters/party/zayn_cutscene.png`,
